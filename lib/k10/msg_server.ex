...
defmodule K10.MsgServer do
  ...
  def kos_dir_publish(_protocol_name, _request_label, _request_badge, _request_flags), do: :erlang.nif_error("Did not find kos_dir_publish")
  def kos_dir_unpublish(_protocol_name), do: :erlang.nif_error("Did not find kos_dir_unpublish")
  def kos_dir_query(_protocol_name), do: :erlang.nif_error("Did not find kos_dir_query")
  def kos_dir_request(_protocol_name, _empty_token_slot, _msg), do: :erlang.nif_error("Did not find kos_dir_request")
